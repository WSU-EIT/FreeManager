...
namespace FreeCICD
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreeCICD.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreeCICD.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<freecicdHub>("/freecicdHub", signalRConnctionOptions => {
