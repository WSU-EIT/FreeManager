...
namespace FreeGLBA
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreeGLBA.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreeGLBA.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<freeglbaHub>("/freeglbaHub", signalRConnctionOptions => {
