...
/// </summary>
public static class FMProjectTemplates
{
    /// <summary>
        ...
        string projectName)
    {
        ...
        switch (template) {
            ...
            case DataObjects.FMProjectTemplate.Starter:
                ...
                files.Add(($"{projectName}.App.razor", "RazorComponent", GetStarterComponent(projectName)));
                files.Add(($"{projectName}Page.App.razor", "RazorPage", GetStarterPage(projectName)));
                break;

            case DataObjects.FMProjectTemplate.FullCrud:
                // Include all Starter files
    ...
    private static string GetSkeletonDataObjects(string name) => $@"namespace CRM;
...
";
    ...
    private static string GetSkeletonDataAccess(string name) => $@"namespace CRM;
...
";
    ...
    private static string GetSkeletonGlobalSettings(string name) => $@"namespace CRM;
...
";
    ...
    private static string GetStarterGlobalSettings(string name) => $@"namespace CRM;
...
";
    ...
    private static string GetFullCrudDataObjects(string name) => $@"namespace CRM;
...
{{
    ...
    {{
        ...
        List<DataObjects.{name}ItemInfo> output = await data.{name}Items
