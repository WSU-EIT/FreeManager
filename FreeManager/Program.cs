using FreeManager.Components;
using FreeManager.Server.Controllers;
using FreeManager.Server.Hubs;
...
namespace FreeManager
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreeManager.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreeManager.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<freemanagerHub>("/freemanagerHub", signalRConnctionOptions => {
            ...
            app.MapRazorComponents<App>()
                ...
                .AddAdditionalAssemblies(typeof(FreeManager.Client.Pages.Index).Assembly);
